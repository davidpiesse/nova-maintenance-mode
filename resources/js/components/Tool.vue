    ...
    <div>
        ...
        <card  class="mb-6 py-3 px-6">
            ...
            <div v-if="!currentlyInMaintenance">
                ...
                <div class="flex border-b border-40">
                    <div class="w-1/4 py-4"><h4 class="font-normal text-80">Retry Time <span class="text-sm">(secs)</span></h4></div>
                    <div class="w-3/4 py-4">
                ...
                <div class="flex border-b border-40">
                    <div class="w-1/4 py-4"><h4 class="font-normal text-80">Allowed IP Addresses</h4></div>
                    <div class="w-3/4 py-4">
                ...
                <div class="flex">
                    <div class="w-1/4 py-4"><h4 class="font-normal text-80">Include your current IP</h4></div>
                    <div class="w-3/4 py-4">
                        <toggle-button v-model="include_current_ip" class="mb-4" width="50" height="22" speed="400"/>
                        <p class="text-danger">NOTE</p>
                        <p class="text-80"> If you uncheck this and do not add your IP address above you will lose access to Nova as well</p>
                    </div>
                </div>
            </div>
